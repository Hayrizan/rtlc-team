...
assets/branding/                 Логотип, favicon и Open Graph-изображение
...
Для крупной карточки добавьте `featured: true`, `image` и при желании цвет `accent`. HTML менять не нужно.

## Images

- Обложки проектов: `assets/projects/`, рекомендуемый формат WebP.
- Фирменные материалы: `assets/branding/`.
- Текущий `logo-placeholder.svg` — временный знак. После получения официального логотипа замените этот файл, сохранив имя, либо обновите путь в `index.html`.
- `social-placeholder.svg` — временная Open Graph-картинка; её стоит заменить фирменным изображением 1200×630.
