...
Для всех 24 игр локально сохранены официальные Steam header-баннеры без кадрирования и отдельные app/community-иконки. Баннеры и иконки оптимизированы в WebP и не зависят от доступности внешнего CDN при загрузке сайта.
